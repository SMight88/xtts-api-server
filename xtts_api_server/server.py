...
BASE_HOST = os.getenv('BASE_URL', '127.0.0.1:8060')
...
XTTS = TTSWrapper(OUTPUT_FOLDER, SPEAKER_FOLDER, MODEL_FOLDER, LOWVRAM_MODE, MODEL_SOURCE, MODEL_VERSION, DEVICE,
                  DEEPSPEED, USE_CACHE, STRING_PARSER)
...
@app.post("/set_replace_vocab")
def set_replace_vocab_endpoint(replace_vocab: Dict[str, Dict[str, str]]):
    try:
        XTTS.set_replace_vocab(replace_vocab)
